...
export class RegisterStudentComponent implements OnInit {
  ...
  @Output() cancelRegisterStudent = new EventEmitter();
  // @Output() cancelRegisterStudent = new EventEmitter();
  ...
  intitializeForm() {
    this.registerForm = this.fb.group({
      ...
      major: ['anonymous', Validators.required],
      dateOfBirth: ['', Validators.required],
      city: ['anonymous', Validators.required],
      country: ['anonymous', Validators.required],
  ...
  cancel() {
    this.cancelRegisterStudent.emit(false);
  }
